...
#Preview {
    VStack(spacing: 16) {
        AirPointerStatusCard(engineState: .idle, calibrationProgress: 0, isRawFallbackIndicatorVisible: false, isFirstUse: true)
        AirPointerStatusCard(engineState: .armed, calibrationProgress: 0, isRawFallbackIndicatorVisible: false, isFirstUse: false)
        AirPointerStatusCard(engineState: .moving, calibrationProgress: 0, isRawFallbackIndicatorVisible: false, isFirstUse: false)
        AirPointerStatusCard(engineState: .calibrating, calibrationProgress: 0.4, isRawFallbackIndicatorVisible: false, isFirstUse: false)
    }
    .padding()
}
