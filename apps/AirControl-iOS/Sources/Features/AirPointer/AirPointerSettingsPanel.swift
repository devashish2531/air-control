// Features/AirPointer/AirPointerSettingsPanel.swift
// Inline quick-settings for the Air Pointer tab: sensitivity + smoothing sliders (spec §4.1.9,
...
// Settings screen models the missing fields against the same `AirPointerLocalSettings` store (or a
// widened `GyroSettings`), this panel can be trimmed to just the two sliders.
import AirControlFilters
import SwiftUI

struct AirPointerSettingsPanel: View {
    @Bindable var viewModel: AirPointerViewModel
