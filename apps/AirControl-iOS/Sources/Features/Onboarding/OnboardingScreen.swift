...
private struct WelcomePage: View {
    ...
    var body: some View {
        OnboardingPageLayout(
            ...
            title: Text("Your iPhone is now a trackpad, air pointer and keyboard for your Mac.", comment: "Onboarding page 1 (spec §4.1.1)"),
            message: nil,
...
private struct LocalNetworkPage: View {
    ...
    var body: some View {
        OnboardingPageLayout(
            ...
            message: Text("Air Control needs to see devices on your Wi-Fi to find your Mac. iOS will ask you next. Nothing leaves your network.", comment: "Onboarding page 3 (spec §4.1.1)"),
            primaryTitle: Text("Continue", comment: "Onboarding primary action"),
            onPrimary: onContinue,
            secondaryTitle: Text("Skip", comment: "Onboarding: skips the remaining first-run pages"),
            onSecondary: onSkip
...
private struct CameraPermissionPage: View {
    ...
    var body: some View {
        OnboardingPageLayout(
            ...
            message: Text("Air Control uses the camera only to scan the QR code your Mac shows during pairing. Nothing is recorded or stored.", comment: "Onboarding camera page body"),
            primaryTitle: Text("Continue", comment: "Onboarding primary action"),
...
private struct InstallHelperPage: View {
    let onFinished: () -> Void
    private let brewCommand = "brew install --cask air-control"
    private let releasesURLString = "https://github.com/air-control/air-control/releases/latest"
