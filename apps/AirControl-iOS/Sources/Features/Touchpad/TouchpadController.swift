...
// (AirControlFilters, finished, not modified here) has no gain/sensitivity field at all, exactly
...
public final class TouchpadController: TouchpadIntentSink {
    ...
    // spec §4.2.5) rather than inventing a new wire path — mirrors `AirPointerViewModel.scrollChanged
    // /scrollEnded` (Features/AirPointer, another agent's file, not modified here)'s translation-
