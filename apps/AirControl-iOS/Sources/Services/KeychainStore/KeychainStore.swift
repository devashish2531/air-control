...
public enum KeychainKey {
    ...
    public static let clientIdentityKeyTag = "com.aircontrol.app.identity"
    /// `kSecClassCertificate` label for the client's own identity certificate.
    public static let clientIdentityCertificateLabel = "AirControl Client Identity v2" // v2: software key (SE-backed v1 identities fail mutual TLS on device)
    ...
    public static let trustedHostCertificateLabelPrefix = "AirControl Trusted Host "
}
