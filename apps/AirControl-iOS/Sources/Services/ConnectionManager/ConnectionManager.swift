...
// backoff, suspend/resume, heartbeat/probe, error mapping. Wraps `AirControlCore`'s pure
...
public final class ConnectionManager: ConnectionManaging, PairingRouting, @unchecked Sendable {
    ...
    private var coreState: AirControlCore.ConnectionState = .idle
    ...
    /// with no `%zone`) before they ever reach `AddressSelector` — `AirControlProtocol.IPLiteral`'s
...
/// `TaskGroup.addTask` closures — mirrors `AirControlCrypto.GeneratedIdentity`'s own rationale:
