...
// (CLAUDE.md: "AirControlCore never imports Network"; only the Connection agent's session type
...
public actor MotionPublisher: MotionEnqueuing {
    private let serialQueue = DispatchSerialQueue(label: "com.aircontrol.app.motion", qos: .userInteractive)
