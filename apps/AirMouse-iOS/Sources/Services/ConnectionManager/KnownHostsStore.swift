...
// immediately").
//
// `AirMouseCore.TrustedDeviceRecord` is documented as host-side-shaped ("from the host's point of
// view"), but it is the only `Codable`, versionable trust record `AirMouseCore` exports, and this
...
/// The two documents this store persists under `Application Support/AirMouse/`.
