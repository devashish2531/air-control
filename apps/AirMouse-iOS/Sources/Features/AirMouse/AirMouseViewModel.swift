// Features/AirMouse/AirMouseViewModel.swift
// Owns `GyroEngine`'s lifecycle and translates the Air Mouse tab's gestures (clutch, click area,
...
@MainActor
@Observable
public final class AirMouseViewModel {
    public let engine: GyroEngine
    public let localSettings: AirMouseLocalSettings
    ...
    public init(
        engine: GyroEngine,
        localSettings: AirMouseLocalSettings,
    ...
    // strip — see the deviation note in `AirMouseScreen.swift`.)
