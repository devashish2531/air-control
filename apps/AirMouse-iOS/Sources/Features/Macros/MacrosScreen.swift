...
private struct MacrosGridView: View {
    ...
    private var emptyState: some View {
        ContentUnavailableView {
            ...
            Text("Add macros in the Air Mouse menu on your Mac.", comment: "Macros empty state description, spec §4.1.8")
        }
...
private struct MacroButtonView: View {
    ...
    /// `MacroValidator` (AirMouseProtocol) only checks non-emptiness — SF Symbol catalog
