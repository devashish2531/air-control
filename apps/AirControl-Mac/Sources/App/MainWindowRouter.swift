...
public final class MainWindowRouter {
    ...
    /// `openWindow` environment action — specifically `AirControlHelperApp.AppDelegate.
    ...
    /// single router instance `AirControlHelperApp` creates. Set once, from `MenuBarIconLabel`'s
