...
@main
struct AirControlHelperApp: App {
    ...
    var body: some Scene {
        ...
        // bar's "Quit Air Control" button (`MenuBarScene`), which is unaffected by this scene.

        Window("Air Control Setup", id: WindowID.onboarding) {
