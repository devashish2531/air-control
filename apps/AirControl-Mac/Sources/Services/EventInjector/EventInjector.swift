...
/// Real-time `Clock` (`AirControlFilters.Clock`) backed by `ProcessInfo.systemUptime`, matching the
...
public actor EventInjector: EventInjecting {
    ...
    public init(
        ...
        queueLabel: String = "com.aircontrol.helper.inject"
    ) {
    ...
    /// host-wide, not per-session, until `AirControlCore` gives us session identity.) Exposed
