// MockHostControlChannel — an in-memory `AirMouseCore.ControlChannel` pair for testing
...
/// `AirMouseCore.HostSession`/`ClientSession` expect — see `NWControlChannel`'s doc comment).
