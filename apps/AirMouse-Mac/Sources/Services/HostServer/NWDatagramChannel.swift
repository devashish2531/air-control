// NWDatagramChannel + NWUDPHub — Network.framework implementation of `AirMouseCore.DatagramChannel`
...
/// synchronous (matching `AirMouseCore.DatagramChannel`'s non-`async` `send(_:) throws` — the
...
public final class NWUDPHub: @unchecked Sendable {
    private struct State {
        ...
        /// Bumped on every datagram rejected before it reaches `AirMouseCore` (wrong length, or a
    ...
    public init(queueLabel: String = "com.airmouse.helper.net.udp") {
