...
- Open: owner verification of motion on device after `5ac88c5`; Mac Overview lacks "connected since" (host service exposes no timestamp); iOS display name still "Air Mouse".
