...
/// apps (arch §3.1: "Keychain-backed implementations live in the apps"); `AirMouseCore` only
/// defines the shape and ships `InMemoryTrustStore` for tests and `airmouse-cli`.
