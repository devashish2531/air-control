...
/// concrete `AirMouseFilters` configuration the host's injection pipeline runs.
...
/// `EventInjector`/`MotionPipeline` (spec §5.4, §3.6.1). `AirMouseCore` only translates settings
...
extension EffectiveSettings: Equatable {
    ...
    /// owned by `AirMouseFilters`, and a retroactive `extension ... Equatable` here would risk a
