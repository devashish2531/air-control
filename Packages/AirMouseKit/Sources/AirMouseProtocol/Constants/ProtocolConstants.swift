...
/// literal (CLAUDE.md: "every wire constant comes from `AirMouseProtocol` constants, never
...
public enum ProtocolConstants {
    ...
    /// Protocol major version this build of `AirMouseProtocol` speaks. spec §3.0: "Protocol
