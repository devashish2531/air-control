...
// TODO(integration): `AirMouseProtocol` is specified to own the canonical `Data.b64u` helper
// (arch §3.1 public API table). This module cannot import AirMouseProtocol (see module header), so
...
// replace call sites here with `AirMouseProtocol.Data.b64u` and delete this file, or leave both if
// `AirMouseCrypto` must stay independently testable.
