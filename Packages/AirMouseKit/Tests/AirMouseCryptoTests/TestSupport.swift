...
/// Shared helpers for the frozen-vector tests. Not part of the `AirMouseCrypto` public API.
...
/// Loads a JSON vector file from `Tests/AirMouseCryptoTests/Vectors/<name>.json` (packaged as a
