...
/// Local (non-wire) error type thrown by `AirControlProtocol`'s decoding, framing, validation and
...
public enum ProtocolError: Error, LocalizedError, Sendable, Equatable {
    ...
    /// spec §3.1.3: an `aircontrol://pair` URL failed to parse or a parameter failed validation.
