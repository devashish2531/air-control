...
# AirMouseHelper yet. Until `UpdateService` exists, this script writes a well-formed but
...
#
# <dist-dir> must contain the release DMG named AirMouse-<version-without-v>.dmg and its
...
dmg_path="$dist_dir/AirMouse-${version}.dmg"
...
download_url="https://github.com/OWNER/air-mouse/releases/download/${version_tag}/$(basename "$dmg_path")"
...
<!--
  PLACEHOLDER appcast — Sparkle is not yet integrated into AirMouseHelper (see CLAUDE.md
...
<rss xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" xmlns:dc="http://purl.org/dc/elements/1.1/" version="2.0">
  <channel>
    <title>Air Mouse Changelog</title>
    <link>https://OWNER.github.io/air-mouse/appcast.xml</link>
    <item>
